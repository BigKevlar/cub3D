...
/*   Updated: 2024/09/06 09:13:03 by jmartos-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_textures(t_game *game)
{
	...
	game->tex->n = mlx_load_png("Textures/Stone1L.png");
	game->tex->s = mlx_load_png("Textures/Stone1L.png");
	game->tex->e = mlx_load_png("Textures/Stone1L.png");
	game->tex->w = mlx_load_png("Textures/Stone1L.png");
}
